...
const Category = () => {
  ...
  return (
    <div className="px-6 md:px-20 py-16 bg-white dark:bg-blue-900 text-center">
      ...
      <p className="text-gray-500 mb-12 dark:text-white">
        امروزه به دلیل آن که ارتباطات فضای مجازی رونق زیادی یافته است
      </p>

      <div className="w-full bg-gray-50 py-12 rounded-full dark:bg-blue-950">
