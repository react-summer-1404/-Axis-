...
const HeroSection = () => {
  return (
   <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-12 bg-gradient-to-r from-[#f8f5ff] to-white">
  ...
  <div className="flex-1 text-right mt-8 md:mt-0 md:pr-10">
