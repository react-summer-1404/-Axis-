...
<h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 leading-snug text-center md:text-right dark:text-white">
  ...
  برتر اکنون در یک مکان
          ...
          <p className="text-gray-500 mb-6 text-sm md:text-base leading-relaxed dark:text-white">
...
سازماندهی و اولویت بندی در مورد پایه پلتفرم وب
          ...
          <ul className="space-y-3 mb-8 text-gray-700 dark:text-white">
            <li className="flex items-center font-bold justify-center md:justify-end gap-2 dark:text-white">
