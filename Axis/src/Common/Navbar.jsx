    ...
    <div className='h-[120px] border m-auto relative' >
        ...
        <Link to="/">
          <div  className='flex items-center flex-row-reverse gap-3 justify-end px-3 mt-7' dir='rtl'   > 
              <div className='text-right' > <p className='text-lg font-bold text-gray-800 dark:text-gray-100'>نامبر وان</p> 
        ...
        <p className='hover:text-[#5751E1]  cursor-pointer dark:text-gray-300 dark:hover:text-[#5751E1]'><Link to="/courses"> دوره ها</Link></p>
        ...
        {/* search */}
        <div className='border rounded-full w-[400px] h-[50px] border-gray-300 absolute bottom-9 left-[320px] flex dark:bg-slate-100'>
          <div> 
          <select className="  px-1 py-1 text-right focus:outline-none  relative top-2 left-60 bg-white dark:bg-slate-100" dir='rtl'>
          ...
          <input type='search'  placeholder='جستجو برای دوره...' dir='rtl' className=' relative right-1 w-32 focus:outline-none dark:bg-slate-100'/>
         </div>
