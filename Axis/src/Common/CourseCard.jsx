...
const CourseCard = ({ course }) => {
  ...
  return (
    <div className="max-w-10  m-4 md:max-w-sm mx-auto bg-white rounded-xl shadow-lg hover:shadow-2xl transition duration-300 overflow-hidden  border border-gray-100 dark:bg-gray-50 dark:border-[#ffff]">
      {/* بخش تصویر */}
      ...
      <div className="p-4 sm:p-5 text-right space-y-3">
        ...
        <div className="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400 border-t pt-3 mt-3 border-gray-100 dark:border-gray-700">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
          <div className="flex items-center space-x-4 space-x-reverse text-sm font-semibold">
            ...
            <div className="flex items-center">
              <button className="flex items-center p-2 bg-green-50 rounded-lg text-green-700 hover:bg-green-100 transition dark:bg-green-900/50 dark:hover:bg-green-900">
            ...
            <div className="flex items-center">
              <button className="flex items-center p-2 bg-red-50 rounded-lg text-red-700 hover:bg-red-100 transition dark:bg-red-900/50 dark:hover:bg-red-900">
